...
contextBridge.exposeInMainWorld('api', {
	...
	updatePlaylist: (playlistId, data) => ipcRenderer.invoke('jellyfin:updatePlaylist', { playlistId, data }),
	updatePlaylistCover: (playlistId, imageData) => ipcRenderer.invoke('jellyfin:updatePlaylistCover', { playlistId, imageData }),
	removePlaylistCover: (playlistId) => ipcRenderer.invoke('jellyfin:removePlaylistCover', playlistId),
	deletePlaylist: (playlistId) => ipcRenderer.invoke('jellyfin:deletePlaylist', playlistId),
